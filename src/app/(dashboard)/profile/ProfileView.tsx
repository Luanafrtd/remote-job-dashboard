...
export function ProfileView() {
  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <div>
              ...
              <CardDescription>
                Showcased on your public profile
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
            <div className="flex flex-wrap gap-2">
              {currentUser.skills.map((skill) => (
                <span
                  key={skill}
                  className="bg-surface-muted text-foreground rounded-full px-3 py-1 text-xs font-medium"
                >
                  {skill}
                </span>
              ))}
      ...
      <Toast message="Profile updated." show={saved} />
    </div>
  );
}
